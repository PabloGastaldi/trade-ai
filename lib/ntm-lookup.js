...
/**
 * Resuelve un nombre de país en español coloquial a su código ISO3.
 * @param {string} nombrePais — ej: "China", "Estados Unidos", "Unión Europea"
 * @returns {string|null} — código ISO3 o null si no se reconoce
 */
...
// ─────────────────────────────────────────────
/**
 * Busca barreras no arancelarias en la tabla ntm_measures para un producto.
 * @param {string} hs_code — código HS de 6 dígitos (ej: "060290")
 * @param {{ reporter?: string|null, direction?: 'export'|'import' }} options
 *   - reporter: ISO3 del país (filtra a un solo país; null = todos)
 *   - direction: 'export' = barreras que otros le ponen a Argentina; 'import' = barreras de Argentina a otros
 * @returns {Promise<Array<{ pais: string, iso3: string, medidas: Array<{ codigo: string, tipo: string, cobertura: string }> }>>}
 */
...
// ─────────────────────────────────────────────
/**
 * Formatea resultados de buscarBarrerasNTM como bloque de texto para el prompt de Claude.
 * @param {Array} resultados — output de buscarBarrerasNTM()
 * @param {{ hs_code?: string, direction?: string }} options
 * @returns {string}
 */
