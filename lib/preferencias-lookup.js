...
// ─────────────────────────────────────────────
/**
 * Busca preferencias arancelarias (acuerdos de importación y exportación) para un NCM.
 * @param {string} ncmCode — código NCM en cualquier formato soportado por normalizarCodigoNCM()
 * @returns {Promise<{
 *   ncm_code: string,
 *   codigo_ncm: string,
 *   tiene_preferencias: boolean,
 *   preferencias_especificas: Array<{ acuerdo: string, pais: string, porcentaje: number, tipo: 'importacion'|'exportacion' }>,
